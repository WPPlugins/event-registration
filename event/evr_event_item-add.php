...
.er_ticket_info a{
    cursor:default!important;
    background:url(<?php echo plugins_url( 'images/info-icon.png', dirname(__FILE__) );?>) no-repeat bottom left;
    text-decoration:none;
    position:relative;top:-1px
}
                ...
                <br /><ul>
				    ...
				    <li>
                        <label  class="er_ticket_info" title="<?php _e('Please select no for event pricing setup, select yes for free event','evr_language');?>">
        					<?php _e('Will this be a free item?','evr_language');?><a><span>
                            <?php echo '<img src="' . plugins_url( 'images/info-icon.png', dirname(__FILE__) ) . '" > ';?>
                            </span></a></label>
